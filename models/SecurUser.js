...
const SecurUserSchema = new mongoose.Schema({
  ...
  role: { type: String, enum: ["admin","soporte","usuario","visualizador","puertos","ajustador_lider","ajustador","inspector","contractor_zurich","contractor_alfa","contractor_sura","contractor_solo_zurich","contractor_solo_bbva","contractor_solo_equidad","contractor_solo_previsora","contractor_catastroficos"], required: true },
  phone: { type: String },
