...
const SecurUserSchema = new mongoose.Schema({
  ...
  role: { type: String, enum: ["admin","soporte","usuario","visualizador","puertos","contractor_zurich","contractor_alfa","contractor_sura","contractor_solo_zurich"], required: true },
  phone: { type: String },
