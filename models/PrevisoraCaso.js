...
/**
 * Casos Previsora (módulo catastrófico estilo Alfa).
 * Puede alimentarse desde Excel o sincronizarse desde Express (SiniestroExpress).
 */
const PrevisoraCasoSchema = new mongoose.Schema(
  {
    /** Formato PREVISORA-YYYY-MM-N (asignado al crear; no editable) */
    consecutivo: String,
    ...
    celular: String,
    /** Canal de radicación (Previsora, presencial, etc.) */
    ...
    /**
     * Severidad CAT Previsora (Manual CAT Ajustadores): 1–6 para reporte de exposición.
    ...
    /** Estado del liquidador Previsora */
...
const PrevisoraCaso = mongoose.model(
  'PrevisoraCaso',
  PrevisoraCasoSchema,
  'gsk3cAppprevisoraCasos'
);

export default PrevisoraCaso;
