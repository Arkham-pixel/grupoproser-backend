...
/**
 * Casos Zurich (módulo catastrófico estilo Alfa).
 * Puede alimentarse desde Excel o sincronizarse desde Express (SiniestroExpress).
 */
const ZurichCasoSchema = new mongoose.Schema(
  {
    /** Formato ZURICH-YYYY-MM-N (asignado al crear; no editable) */
    consecutivo: String,
    ...
    /** Campos operativos CAT Zurich (hoja CAT_ZURICH / exposición) */
    ...
    /**
     * Severidad CAT Zurich (Manual CAT Ajustadores): 1–6 para reporte de exposición.
