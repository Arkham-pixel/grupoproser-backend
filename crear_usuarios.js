...
const UsuarioSchema = new mongoose.Schema({
  ...
  rol: { type: String, enum: ["admin","soporte","usuario","visualizador","puertos","contractor_zurich","contractor_alfa","contractor_sura","contractor_solo_zurich","contractor_solo_bbva","contractor_solo_equidad","contractor_solo_previsora","contractor_catastroficos"], default: "usuario" },
