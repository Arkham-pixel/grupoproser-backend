...
const es = {
  ...
  alertsSystemAlfa: 'Sistema de Alertas Seguros Alfa',
  alertsSystemNamed: 'Sistema de Alertas {nombre}',
  ...
  recAlfa: 'Sube documentos pendientes y actualiza el estado del caso Alfa',
  ...
  subjectAlertasAlfa: 'SEGUROS ALFA',
...
const en = {
  ...
  alertsSystemAlfa: 'Seguros Alfa Alerts System',
  alertsSystemNamed: '{nombre} Alerts System',
  ...
  recAlfa: 'Upload pending documents and update the Alfa case status',
