/**
 * Crea/actualiza a Adriel José Escorcia Pulgar y Emiro Miguel Ortega Meza
 * con rol contractor_zurich (Zurich, Alfa, Sura y BBVA).
 *
 * Uso: node scripts/crear_usuarios_adriel_emiro.js
 */
import dns from 'dns';
...
const PERSONAS = [
  {
    ...
    telefono: '3005555870',
    cedula: '1002500141',
    fechaNacimiento: new Date(2003, 5, 24),
  },
  {
    nombre: 'Emiro Miguel Ortega Meza',
    email: 'emiroortega001@gmail.com',
    telefono: '3106246381',
    cedula: '8533719',
...
async function main() {
  ...
  for (const p of PERSONAS) {
    ...
    if (p.fechaNacimiento) payload.fechaNacimiento = p.fechaNacimiento;
