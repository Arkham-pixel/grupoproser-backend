...
const PROYECCION_LISTA_SURA = {
  ...
  valorReclamado: 1,
  valorLiquidado: 1,
  liquidacionPresupuestoTotal: 1,
  liquidacionDeduciblePresupuesto: 1,
  liquidacionValorIndemnizarPresupuesto: 1,
  liquidacionTotalContenidos: 1,
  liquidacionDeducibleContenidos: 1,
  liquidacionValorIndemnizarContenidos: 1,
  liquidacionTotalIndemnizar: 1,
  valorAseguradoFechaSiniestro: 1,
  valorDeducibleCalculo: 1,
  fechaLlamada: 1,
...
export const listarCasosSura = async (req, res) => {
  try {
    ...
    if (numero) {
      filtroNumero = { $or: [{ nmroAjste: numero }, { consecutivo: numero }, { siniestro: numero }] };
    }
