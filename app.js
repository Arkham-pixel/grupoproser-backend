...
console.log('✅ Ruta /api/tickets registrada');
...
console.log('✅ Ruta /api/puertos registrada');
...
console.log('✅ Ruta /api/ia registrada (gateway; activo solo con ARNALD_IA_ENABLED=true)');
console.log('📱 Portal asegurado:', `${resolveVideoperitajePublicUrl()}/videoperitaje/unirse/<token>`);
console.log('🌐 FRONTEND_URL:', process.env.FRONTEND_URL || '(vacío → fallback)');
console.log('🌐 BASE_URL:', process.env.BASE_URL || process.env.BACKEND_URL || '(vacío → fallback)');
console.log('📹 LIVEKIT_URL:', process.env.LIVEKIT_URL || '(no configurado)');
console.log('📹 LIVEKIT_PUBLIC_URL:', process.env.LIVEKIT_PUBLIC_URL || '(vacío → LIVEKIT_URL)');
console.log('🤖 ARNALD_IA_ENABLED:', process.env.ARNALD_IA_ENABLED || 'false');
console.log('📹 VIDEOPERITAJE_EN_CAT:', process.env.VIDEOPERITAJE_EN_CAT || 'false');
